# =============================================================================
# template_generator.py — Génération des templates PWA (v3.0)
# =============================================================================
# Module de génération des templates pour le Dashboard PWA
...
def generate_manifest(dashboards_dir):
    """
    Générer le fichier manifest.json pour PWA (Progressive Web App).

    Args:
        dashboards_dir (str): Répertoire racine des dashboards

    Output:
        dashboards_dir/manifest.json: Configuration PWA

    Notes:
        - Permet l'installation sur mobile
        - Icône: emoji 🏠
        - Thème: gradient purple #667eea → #764ba2
    """
    manifest = {
...
def generate_html(stats, site_colors):
    """
    Générer le HTML complet du dashboard PWA v2.0.

    Args:
        stats (dict): Statistiques complètes (from data_processor.calc_stats)
        site_colors (dict): Couleurs par site (from data_processor.export_data)

    Returns:
        str: HTML complet avec CSS imbriqué et JavaScript

    Features incluses:
        - Indicateurs de qualité des données
        - Détection d'anomalies
        - Tableau triable et filtrable
        - Vue par ville avec stats
        - Vue par gamme de prix
        - Carte Leaflet avec toggle Markers/Heatmap
        - Heatmap de densité annonces
        - Timeline interactive
        - Boutons partage social (WhatsApp, Telegram)
        - QR codes pour annonces
        - Responsive design mobile
        - PWA compatible

    Notes:
        - Utilise Bootstrap 5 + Leaflet.js via CDN
        - Scripts entièrement inline
        - Zéro JS externe (sauf CDN)
    """
